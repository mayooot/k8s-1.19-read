...
func (ps *Plugins) getPlugin(name string, config io.Reader) (Interface, bool, error) {
	...
	// 研究 ps.registry是啥时候初始化的
	// 可以看下ps.registry的定义：map[string]Factory，Factory 是一个函数，用于根据入参配置，返回一个 Interface 的实例
...
// 创建一个实现了 Interface 接口的实例
// Interface 是一个可插拨式的接口，用于准入控制的决定
